  ...
  <div class="px-4 pt-8">
    ...
    <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
      <div v-for="checkout in getCart" :key="checkout.cart_id" class="flex flex-col rounded-lg bg-white sm:flex-row">
        <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src="../assets/erigo5.jpg" alt="" />
        <div class="flex w-full flex-col px-4 py-4">
          <span class="font-semibold">{{ checkout.name }}</span>
          <span class="float-right text-gray-400">42EU - 8.5US</span>
          <p class="text-lg font-bold">Rp.{{checkout.regular_price }}</p>
        </div>
      </div>
    </div>
      ...
      <div class="relative">
        ...
        <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_1">
          ...
          <div class="ml-5">
            ...
            <p class="text-slate-500 text-sm leading-6">Delivery cost : Rp.0</p>
            <p class="text-slate-500 text-sm leading-6">Delivery timing : 1 days</p>
          </div>
        </label>
      </div>
      <div class="relative">
